...
/**
 * A {@code Multiset} whose contents will never change, with many other important properties
...
public abstract class ImmutableMultiset<E> extends ImmutableMultisetGwtSerializationDependencies<E>
   ...
   *
   * <p>If the mapped elements contain duplicates (according to {@code Object#equals}), the first
