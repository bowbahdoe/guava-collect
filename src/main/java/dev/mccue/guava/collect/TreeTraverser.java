 ...
 * @since 15.0
 * @deprecated Use {@code dev.mccue.guava.graph.Traverser} instead. All instance methods have
 *     their equivalent on the result of {@code Traverser.forTree(tree)} where {@code tree}
 *     implements {@code SuccessorsFunction}, which has a similar API as {@code #children} or can be
 *     the same lambda function as passed into {@code #using(Function)}.
...
public abstract class TreeTraverser<T> {
   ...
   * {@code TreeTraverser} and implement its {@code #children} method directly.
   *
   * @since 20.0
   * @deprecated Use {@code dev.mccue.guava.graph.Traverser#forTree} instead. If you are using a
   ...
   * is in progress or when the iterators generated by {@code #children} are advanced.
   *
   * @deprecated Use {@code dev.mccue.guava.graph.Traverser#depthFirstPreOrder} instead, which has
   *     the same behavior.
   */
  @Deprecated
   ...
   * is in progress or when the iterators generated by {@code #children} are advanced.
   *
   * @deprecated Use {@code dev.mccue.guava.graph.Traverser#depthFirstPostOrder} instead, which
   ...
   * is in progress or when the iterators generated by {@code #children} are advanced.
   *
   * @deprecated Use {@code dev.mccue.guava.graph.Traverser#breadthFirst} instead, which has the
   *     same behavior.
   */
  @Deprecated
