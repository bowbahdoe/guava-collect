 ...
 * @since 15.0
 * @deprecated Use {@link dev.mccue.guava.graph.Traverser} instead. All instance methods have
...
public abstract class TreeTraverser<T> {
   ...
   *
   * @since 20.0
   * @deprecated Use {@link dev.mccue.guava.graph.Traverser#forTree} instead. If you are using a
   ...
   *
   * @deprecated Use {@link dev.mccue.guava.graph.Traverser#depthFirstPreOrder} instead, which has
   *     the same behavior.
   */
  @Deprecated
   ...
   * is in progress or when the iterators generated by {@link #children} are advanced.
   *
   * @deprecated Use {@link dev.mccue.guava.graph.Traverser#depthFirstPostOrder} instead, which
   ...
   * is in progress or when the iterators generated by {@link #children} are advanced.
   *
   * @deprecated Use {@link dev.mccue.guava.graph.Traverser#breadthFirst} instead, which has the
   *     same behavior.
   */
  @Deprecated
