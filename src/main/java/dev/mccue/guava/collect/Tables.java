...
import dev.mccue.guava.collect.Table.Cell;
...
public final class Tables {
  ...
  /**
   * Returns a {@code Collector} that accumulates elements into a {@code Table} created using the
   ...
   *
   * <p>To collect to an {@code ImmutableTable}, use {@code ImmutableTable#toImmutableTable}.
   *
   * @since 21.0
   */
  public static <
   ...
   * used to combine the values. Like {@code
   ...
   * analogous operation with swapped rows and columns. For example, in a {@code HashBasedTable}
   * instance, {@code rowKeySet().iterator()} supports {@code remove()} but {@code
   * columnKeySet().iterator()} doesn't. With a transposed {@code HashBasedTable}, it's the other
   * way around.
   */
  public static <R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object>
   ...
   *
   * <p>Call this method only when the simpler factory methods in classes like {@code
   * HashBasedTable} and {@code TreeBasedTable} won't suffice.
   *
   * <p>The views returned by the {@code Table} methods {@code Table#column}, {@code
   * Table#columnKeySet}, and {@code Table#columnMap} have iterators that don't support {@code
   ...
   * operations like {@code Table#containsValue} and {@code Table.toString()}. For this to perform
   ...
   *
   * <p>Consider using an {@code ImmutableTable}, which is guaranteed never to change.
   *
   * @since 11.0
   */
  public static <R extends @Nullable Object, C extends @Nullable Object, V extends @Nullable Object>
