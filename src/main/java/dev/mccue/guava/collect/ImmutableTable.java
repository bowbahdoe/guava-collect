...
/**
 * A {@code Table} whose contents will never change, with many other important properties detailed
...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V>
   ...
   *
   * <p>The {@code Table#cellSet()} iteration order of the provided table determines the iteration
   * ordering of all views in the returned table. Note that some views of the original table and the
   * copied table may have different iteration orders. For more control over the ordering, create a
   * {@code Builder} and call {@code Builder#orderRowsBy}, {@code Builder#orderColumnsBy}, and
   * {@code Builder#putAll}
   *
   ...
   * ordering of all views in the returned table, with {@code #putAll} following the {@code
   * Table#cellSet()} iteration order. However, if {@code #orderRowsBy} or {@code #orderColumnsBy}
   * is called, the views are sorted by the supplied comparators.
   *
   * <p>For empty or single-cell immutable tables, {@code #of()} and {@code #of(Object, Object,
  ...
  public static final class Builder<R, C, V> {
     ...
     * table. Duplicate key pairs are not allowed and will cause {@code #build} to fail.
     */
    @CanIgnoreReturnValue
     ...
     * pairs are not allowed and will cause {@code #build} to fail.
     */
    @CanIgnoreReturnValue
     ...
     * column key pairs are not allowed, and will cause {@code #build} to fail.
     *
   ...
   * {@inheritDoc}
   *
   * <p>The value {@code Map<R, V>} instances in the returned map are {@code ImmutableMap} instances
   * as well.
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>The value {@code Map<C, V>} instances in the returned map are {@code ImmutableMap} instances
   * as well.
   */
  @Override
