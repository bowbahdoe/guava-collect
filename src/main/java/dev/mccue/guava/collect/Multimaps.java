...
import dev.mccue.guava.collect.Maps.EntryTransformer;
...
public final class Multimaps {
   ...
   * }</pre>
   *
   * <p>To collect to an {@code ImmutableMultimap}, use either {@code
   * ImmutableSetMultimap#toImmutableSetMultimap} or {@code
   ...
   * implement either {@code List} or {@code Set}! Use the more specific method {@code
   * #newListMultimap}, {@code #newSetMultimap} or {@code #newSortedSetMultimap} instead, to avoid
   * very surprising behavior from {@code Multimap#equals}.
   *
   ...
   * work correctly. To allow concurrent update operations, wrap the multimap with a call to {@code
   * #synchronizedMultimap}.
   *
   * <p>Call this method only when the simpler methods {@code ArrayListMultimap#create()}, {@code
   * HashMultimap#create()}, {@code LinkedHashMultimap#create()}, {@code
   * LinkedListMultimap#create()}, {@code TreeMultimap#create()}, and {@code
   ...
   * multimap based on arbitrary {@code Map} and {@code List} classes.
   *
   * <p>The {@code factory}-generated and {@code map} classes determine the multimap iteration
   * order. They also specify the behavior of the {@code equals}, {@code hashCode}, and {@code
   ...
   *
   * <p>Call this method only when the simpler methods {@code ArrayListMultimap#create()} and {@code
   ...
   * multimap based on arbitrary {@code Map} and {@code Set} classes.
   *
   * <p>The {@code factory}-generated and {@code map} classes determine the multimap iteration
   * order. They also specify the behavior of the {@code equals}, {@code hashCode}, and {@code
   * toString} methods for the multimap and its returned views. However, the multimap's {@code get}
   ...
   *
   * <p>Call this method only when the simpler methods {@code HashMultimap#create()}, {@code
   * LinkedHashMultimap#create()}, {@code TreeMultimap#create()}, and {@code
   * TreeMultimap#create(Comparator, Comparator)} won't suffice.
   *
   ...
   * a multimap based on arbitrary {@code Map} and {@code SortedSet} classes.
   *
   * <p>The {@code factory}-generated and {@code map} classes determine the multimap iteration
   * order. They also specify the behavior of the {@code equals}, {@code hashCode}, and {@code
   * toString} methods for the multimap and its returned views. However, the multimap's {@code get}
   ...
   *
   * <p>Call this method only when the simpler methods {@code TreeMultimap#create()} and {@code
   * TreeMultimap#create(Comparator, Comparator)} won't suffice.
   *
   * <p>Note: the multimap assumes complete ownership over of {@code map} and the sets returned by
   * {@code factory}. Those objects should not be manually updated and they should not use soft,
   ...
   * reversed.
   *
   * <p>If {@code source} is an {@code ImmutableMultimap}, consider using {@code
   ...
   *
   * <p>Note that the generated multimap's {@code Multimap#removeAll} and {@code
   ...
   *
   * <p>You must follow the warnings described in {@code #synchronizedMultimap}.
   *
   * <p>The returned multimap will be serializable if the specified multimap is serializable.
   *
  ...
  /**
   * Returns an unmodifiable view of the specified collection of entries. The {@code Entry#setValue}
   * operation throws an {@code UnsupportedOperationException}. If the specified collection is a
  ...
  /**
   * Returns {@code ListMultimap#asMap multimap.asMap()}, with its type corrected from {@code Map<K,
  ...
  /**
   * Returns {@code SetMultimap#asMap multimap.asMap()}, with its type corrected from {@code Map<K,
  ...
  /**
   * Returns {@code SortedSetMultimap#asMap multimap.asMap()}, with its type corrected from {@code
  ...
  /**
   * Returns {@code Multimap#asMap multimap.asMap()}. This is provided for parity with the other
   ...
   * operations like {@code Multimap#containsValue} and {@code Multimap.toString()}. For this to
   ...
   * contrast to {@code #transformValues}, this method's entry-transformation logic may depend on
   ...
   * operations like {@code Multimap#containsValue} and {@code Object#toString}. For this to perform
   ...
   * entries. In contrast to {@code #transformValues(ListMultimap, Function)}, this method's
  ...
  /** A skeleton implementation of {@code Multimap#entries()}. */
  ...
  /** A skeleton implementation of {@code Multimap#asMap()}. */
   ...
   * replaceValues()} methods throw an {@code IllegalArgumentException}.
   *
