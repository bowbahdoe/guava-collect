...
/**
 * An immutable builder for {@code Multimap} instances, letting you independently select the desired
...
public abstract class MultimapBuilder<K0 extends @Nullable Object, V0 extends @Nullable Object> {
   ...
   * Uses a hash table to map keys to value collections.
   *
   * <p>The collections returned by {@code Multimap#keySet()}, {@code Multimap#keys()}, and {@code
  ...
  /**
   * Uses a naturally-ordered {@code TreeMap} to map keys to value collections.
   *
   * <p>The collections returned by {@code Multimap#keySet()}, {@code Multimap#keys()}, and {@code
   * Multimap#asMap()} will iterate through the keys in sorted order.
   *
   * <p>For all multimaps generated by the resulting builder, the {@code Multimap#keySet()} can be
   * safely cast to a {@code java.util.SortedSet}, and the {@code Multimap#asMap()} can safely be
   * cast to a {@code java.util.SortedMap}.
   */
  ...
  /**
   * Uses a {@code TreeMap} sorted by the specified comparator to map keys to value collections.
   *
   * <p>The collections returned by {@code Multimap#keySet()}, {@code Multimap#keys()}, and {@code
   * Multimap#asMap()} will iterate through the keys in sorted order.
   *
  ...
  /**
   * Uses an {@code EnumMap} to map keys to value collections.
   *
   * @since 16.0
   */
  ...
  /**
   * An intermediate stage in a {@code MultimapBuilder} in which the key-value collection map
  ...
  public abstract static class MultimapBuilderWithKeys<K0 extends @Nullable Object> {
    ...
    /** Uses an {@code ArrayList} to store value collections. */
    public ListMultimapBuilder<K0, @Nullable Object> arrayListValues() {
      return arrayListValues(DEFAULT_EXPECTED_VALUES_PER_KEY);
    }

    /**
     * Uses an {@code ArrayList} to store value collections, initialized to expect the specified
    ...
    /** Uses a {@code LinkedList} to store value collections. */
    ...
    /** Uses a naturally-ordered {@code TreeSet} to store value collections. */
    @SuppressWarnings("rawtypes")
    ...
    /**
     * Uses a {@code TreeSet} ordered by the specified comparator to store value collections.
     *
    ...
    /** Uses an {@code EnumSet} to store value collections. */
  ...
  /**
   * A specialization of {@code MultimapBuilder} that generates {@code ListMultimap} instances.
   *
   * @since 16.0
   */
  ...
  /**
   * A specialization of {@code MultimapBuilder} that generates {@code SetMultimap} instances.
   *
   * @since 16.0
   */
  ...
  /**
   * A specialization of {@code MultimapBuilder} that generates {@code SortedSetMultimap} instances.
   *
   * @since 16.0
   */
